...
if __name__ == "__main__":
  ...
  fig.savefig("InletImages/Mesh" + meshNum + "_outlines.png")
  ...
  fig.savefig("InletImages/Mesh" + meshNum + "_weights.png")
  #plt.show()

 
 
  for let in range(0,test_data['iolet_number'].max()+1):
      # fig.savefig("InletImages/Mesh" + meshNum + "inlet" + str(let) + "_weights.png")
